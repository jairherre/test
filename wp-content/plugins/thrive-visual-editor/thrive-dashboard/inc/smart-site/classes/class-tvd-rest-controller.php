...
class TVD_REST_Controller {
	...
	public function get_item( $request ) {
		...
		if ( 1 == 1 ) {
			...
			return new WP_Error( 'code', __( 'message', TVE_DASH_TRANSLATE_DOMAIN ) );
		}
	}
	...
	public function create_item( $request ) {
		...
		return new WP_Error( 'cant-create', __( 'message', TVE_DASH_TRANSLATE_DOMAIN ), array( 'status' => 500 ) );
	}
	...
	public function update_item( $request ) {
		...
		return new WP_Error( 'cant-update', __( 'message', TVE_DASH_TRANSLATE_DOMAIN ), array( 'status' => 500 ) );
	...
	public function delete_item( $request ) {
		...
		return new WP_Error( 'cant-delete', __( 'message', TVE_DASH_TRANSLATE_DOMAIN ), array( 'status' => 500 ) );
	}
