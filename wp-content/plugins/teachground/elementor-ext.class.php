...
final class ElementorExt
{
    ...
    function add_elementor_widget_categories($elements_manager)
    {
        ...
        $elements_manager->add_category(
            'tg-category',
            [
                'title' => __('TeachGround widgets', 'teachground'),
                'icon' => 'fa fa-plug',
            ]
        );
    }
    ...
    public function init_widgets()
    {
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \Elementor_Course_Title_Widget());
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \Elementor_Resource_Widget());
        ...
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \Elementor_List_Widget());
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \Elementor_Progress_Widget());
        \Elementor\Plugin::instance()->widgets_manager->register_widget_type(new \Elementor_All_Courses_Widget());
