...
class TG_copecart_AccessMgmt_Cdata {
	
	public function __construct(){
		if(get_option('tg_copecart_api_key')){
			add_action( 'add_meta_boxes_tg_access_mgmt', array( $this, 'copecart_access_mgmt_cdata' ) );
		}
...
return new TG_copecart_AccessMgmt_Cdata();
