...
class TG_Thrivecart_AccessMgmt_Cdata {
	
	public function __construct(){
		if(get_option('tg_thrivecart_id')){
			add_action( 'add_meta_boxes_tg_access_mgmt', array( $this, 'thrivecart_access_mgmt_cdata' ) );
		}
...
return new TG_Thrivecart_AccessMgmt_Cdata();
