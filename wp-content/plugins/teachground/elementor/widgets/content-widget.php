 ...
 * @since 1.0.0
 */
class Elementor_Content_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return __('TeachGround Lesson Content', 'teachground');
    }
    ...
    protected function render()
    {
        ...
        echo do_shortcode('[tg_lesson_content align="' . $settings["align"] . '"  post_id="' . $settings["post_id"] . '" color="' . $settings["color"] . '" font="' . $settings["font"] . '" font-size="' . $settings["font-size"] . '" font-weight="' . $settings["font-weight"] . '"]');
    }
}
