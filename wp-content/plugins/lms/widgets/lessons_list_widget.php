...
class lessons_list_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'lessons_list_widget',
			'List of Lessons',
			array( 'description' => __( 'Display list of lessons', 'lms' ), )
		);
	 }
	...
	public function form( $instance ) {
        ...
        <p><label for="<?php echo $this->get_field_id('wid_enable_collapsable_outlines'); ?>"><?php _e('Enable Course Outlines Collapsable','lms'); ?> </label>
        ...
        <p><label for="<?php echo $this->get_field_id('wid_enable_open_close_all'); ?>"><?php _e('Enable Open / Close All','lms'); ?> </label>
