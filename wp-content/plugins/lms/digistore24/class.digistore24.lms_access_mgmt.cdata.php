...
class LMS_digistore24_AccessMgmt_Cdata {
	
	public function __construct(){
		if(get_option('lms_digistore24_api_key')){
			add_action( 'add_meta_boxes_lms_access_mgmt', array( $this, 'digistore24_access_mgmt_cdata' ) );
		}
...
return new LMS_digistore24_AccessMgmt_Cdata();
