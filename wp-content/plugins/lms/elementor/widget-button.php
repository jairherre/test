...
class Elementor_Button_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return __('LMS Mark Complete Button', 'lms');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __('Not completed style', 'lms'),
        ...
        $this->add_control(
            'caption',
            [
                'label' => __('Button text (if needed)', 'lms'),
        ...
        $this->add_control(
            'position',
            [
                'label' => __('Button position', 'lms'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'center',
                'options' => [
                    'left'  => __('Left', 'lms'),
                    'center'  => __('Center', 'lms'),
                    'right' => __('Right', 'lms')
                ],
            ]
        );
        ...
        $this->add_control(
            'color-hover',
            [
                'label' => __('Text color on hover', 'lms'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'scheme' => 'COLOR_1'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Background color on hover', 'lms'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'scheme' => 'COLOR_1'
            ]
        );
        ...
        $this->add_control(
            'font-weight',
            [
                'label' => __('Title font weight', 'lms'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'normal',
                'options' => [
                    '100'  => __('Thin', 'lms'),
        ...
        $this->start_controls_section(
            'border_section',
            [
                'label' => __('Not completed border settings', 'lms'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
        ...
        $this->start_controls_section(
            'cc_border_section',
            [
                'label' => __('Completed border settings', 'lms'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
...
?>
        <style>
            .lms-input.text-right {
                text-align: <?php echo $settings['position']; ?>
            }

            #mark-lesson-complete .lms-input input {
            ...
            #mark-lesson-complete .lms-input input:hover {
...
<?php
        echo do_shortcode('[lms_button caption="' . $settings['caption'] . '" cc_caption="' . $settings['cc_caption'] . '"]');
    }
}
