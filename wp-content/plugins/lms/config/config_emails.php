...
global 
$lms_access_assign_subject_default, 
$lms_access_assign_body_default, 
$lms_access_assign_body_admin_default,
$lms_access_unassign_subject_default, 
...
if( defined('WPLANG') or get_option( 'WPLANG' ) != '' ){
    ...
    if( $lang == 'de_DE' ){ // Language for de_DE
        ...
        $lms_access_assign_subject_default = 'DE You have been enrolled to #access_name#';
        $lms_access_assign_body_default = '
        Hallo #first_name#,
        ...
        $lms_access_unassign_subject_default = 'You have been unenrolled from #access_name#';
        $lms_access_unassign_body_default = '
        Hallo #first_name#,
        ...
        $lms_new_user_inserted_subject_default = 'Deine Zugangsdaten';
        $lms_new_user_inserted_body_default = '
        Hallo #first_name#,
        ...
        $lms_forgot_password_link_mail_subject_default = 'Passwort zurücksetzen';
        $lms_forgot_password_link_mail_body_default = '
        ...
        $lms_new_password_mail_subject_default = 'Neues Passwort';
        $lms_new_password_mail_body_default = '
        ...
        $lms_access_assign_subject_default = 'DA You have been enrolled to #access_name#';
        $lms_access_assign_body_default = '
        Dear #display_name#,
        ...
        // user inserted email body user //
        $lms_new_user_inserted_subject_default = 'New user created';
        $lms_new_user_inserted_body_default = '
        Dear #display_name#,
        ...
        // forgot password emails // 
        $lms_forgot_password_link_mail_subject_default = 'Reset Password Link';
        $lms_forgot_password_link_mail_body_default = '
    ...
    $lms_access_assign_subject_default = 'You have been enrolled to #access_name#';
    $lms_access_assign_body_default = '
    Dear #display_name#,
    ...
    $lms_new_password_mail_subject_default = 'New Password Email';
    $lms_new_password_mail_body_default = '
    Your new password for the account at:
